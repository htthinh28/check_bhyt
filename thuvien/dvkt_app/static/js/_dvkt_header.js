    ...
    const SOURCE_TAGS = {
      ...
      BV_PCCT: { label: 'BV PCCT', full: 'CSKCB Cần Thơ', cls: 'bg-teal-100 text-teal-900 border border-teal-200' },
      BV_PSD: { label: 'BV Sa Đéc', full: 'BV Sa Đéc', cls: 'bg-emerald-100 text-emerald-900 border border-emerald-200' },
    };
