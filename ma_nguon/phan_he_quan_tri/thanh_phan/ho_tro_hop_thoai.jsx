/**
 * Hộp thoại quản trị — Alert RN không chạy callback nút trên web.
 */
import { Alert, Platform } from 'react-native';

const laWeb = () => Platform.OS === 'web' && typeof window !== 'undefined';
 ...
 */
export const xacNhanQuanTri = (tieuDe, noiDung = '', { nutXacNhan = 'Xác nhận', nutHuy = 'Hủy' } = {}) => {
