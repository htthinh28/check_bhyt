...
export const DU_LIEU_SEED_LUAT_THUOC_MUC8 = [
  ...
  },
  {
    ...
    "DIEU_KIEN": "XML2.MA_THUOC == '40.155' AND XML1.MA_BENH_CHINH NOT IN ('J01', 'J03', 'J06', 'J15', 'J20', 'L01') AND XML1.MA_BENH_KT NOT LIKE '%J01%' AND XML1.MA_BENH_KT NOT LIKE '%J03%' AND XML1.MA_BENH_KT NOT LIKE '%J06%' AND XML1.MA_BENH_KT NOT LIKE '%J15%' AND XML1.MA_BENH_KT NOT LIKE '%J20%' AND XML1.MA_BENH_KT NOT LIKE '%L01%' AND XML1.CHAN_DOAN_RV NOT REGEXP '(?i)(VIÊM XOANG|VIÊM AMIDAN|VIÊM HỌNG|VIÊM ĐƯỜNG HÔ HẤP TRÊN|NHIỄM TRÙNG HÔ HẤP|VIÊM PHỔI|VIÊM PHẾ QUẢN|CHỐC|NHIỄM TRÙNG DA)'",
    "CANH_BAO": "⛔ [XUẤT TOÁN]: Thuốc Klamentin 875/125 chỉ được thanh toán cho chẩn đoán Nhiễm khuẩn hô hấp hoặc da (J01-J20, L01).",
    "GHI_CHU": "",
    "NGUON_DU_LIEU": "DuLieu_LUAT_THUOC (9).xlsx"
  },
  {
