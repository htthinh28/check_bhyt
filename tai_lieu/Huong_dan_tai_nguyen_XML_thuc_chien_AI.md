...
3. **Prompt gợi ý:** *“Đọc file `…` trong `tai_nguyen`, giải thích cấu trúc GIAMDINHHS và trích `MA_LK` khớp với index.”* — hoặc sau khi import vào CDSS: so sánh kết quả giám định với cùng `MA_LK`.
