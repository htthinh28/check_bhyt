...
| [Ca 000538 — MA_MAY “rác”, X-quang](./Ca_huan_luyen_mau_000538_CDHA_101_ma_may_XQ.md) | `CDHA_101` | `luat_cdha_hardcoded.jsx` (`CDHA-101`) | Chất lượng dữ liệu M06/thiết bị gắn XML3; liên quan kiểm tra **mã máy** theo TT 12 / QĐ 130 (đối chiếu hướng dẫn BHXH) | `test_xml/audit_000538_20260404_221726.json` |
